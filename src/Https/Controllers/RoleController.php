...
use Lwj\Rbac\Services\RoleServiceImpl;
...
class RoleController extends Controller
{
    ...
    public function getAll(Request $request, RoleServiceImpl $roleService)
    {
        return $this->success($roleService->get($request->all()));
    }
